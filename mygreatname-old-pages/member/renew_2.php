...
";
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if (($expire_date != "") && ($hosting == "")) {	
							echo "<tr> <td>$domain</td> <input type=hidden name=domain[] value=$domain> <td>Domain</td> <td>Annual</td> <td>$expire_date</td> <td>$domain_price</td> <input type=hidden name=price[] value=$domain_price> <td>---</td></tr>";
							}
						## sign up Domain and Hosting
						else if (($expire_date != "") && ($hosting != "")) {
							echo "<tr><td>$domain</td><input type=hidden name=domain[] value=$domain><td>Domain</td> <td>Annual</td> <td>$expire_date</td> <td>$domain_price</td> <input type=hidden name=price[] value=$domain_price> <td>--</td></tr>";
		
							echo "<tr><td>$domain $hosting</td><input type=hidden name=domain[] value=$domain><td>Hosting</td> <td>$hosting_renewal_cycle</td> <td>$hosting_expire_date</td> <td>$hosting_price</td> <input type=hidden name=price[] value=$hosting_price> <td>--</td></tr>";
