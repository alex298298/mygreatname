...
$expire_date_from  = $_REQUEST["expire_date_from"];
$expire_date_to    = $_REQUEST["expire_date_to"];
...
$connection = mysqli_connect("localhost", "mygreatn_alex298", "3388mcbody", "mygreatn_domainmember");
...
$msg2 .= "1. Please log in your member Account with your Username and Password.\n";
$msg2 .= "2. Once log in, click the 'Renew Domain' button.\n";
...
While ($row = mysqli_fetch_array($result)) {
	...
	// execute SQL query and get result
	$result_2 = mysqli_query($connection, $sql_2) or die ("Couldn't execute query.");
	...
	While ($row_2 = mysqli_fetch_array($result_2)) {
		...
		echo "$email<p>";
			...
			$msg3  = "MEMBER AREA\n\n";
			$msg3 .= "Here's your username and password to login your member account\n\n";
			$msg3 .= "-------------------------------------------------\n";
